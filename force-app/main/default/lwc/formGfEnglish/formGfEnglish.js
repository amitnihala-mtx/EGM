...
import { OMNIDEF } from './formGfEnglish_def.js';
import tmpl from './formGfEnglish.html';
import tmpl_nds from './formGfEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class formGfEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
