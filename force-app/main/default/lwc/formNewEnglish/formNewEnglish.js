...
import { OMNIDEF } from './formNewEnglish_def.js';
import tmpl from './formNewEnglish.html';
import tmpl_nds from './formNewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class formNewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
