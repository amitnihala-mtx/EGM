...
import { OMNIDEF } from './gFFFFEnglish_def.js';
import tmpl from './gFFFFEnglish.html';
import tmpl_nds from './gFFFFEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class gFFFFEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
