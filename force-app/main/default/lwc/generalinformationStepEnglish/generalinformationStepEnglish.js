...
import { OMNIDEF } from './generalinformationStepEnglish_def.js';
import tmpl from './generalinformationStepEnglish.html';
import tmpl_nds from './generalinformationStepEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class generalinformationStepEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
