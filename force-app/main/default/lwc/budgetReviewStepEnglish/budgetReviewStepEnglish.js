...
import { OMNIDEF } from './budgetReviewStepEnglish_def.js';
import tmpl from './budgetReviewStepEnglish.html';
import tmpl_nds from './budgetReviewStepEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class budgetReviewStepEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
