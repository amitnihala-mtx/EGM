...
import { OMNIDEF } from './testPOCEnglish_def.js';
import tmpl from './testPOCEnglish.html';
import tmpl_nds from './testPOCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testPOCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
