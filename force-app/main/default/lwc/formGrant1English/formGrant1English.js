...
import { OMNIDEF } from './formGrant1English_def.js';
import tmpl from './formGrant1English.html';
import tmpl_nds from './formGrant1English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class formGrant1English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
