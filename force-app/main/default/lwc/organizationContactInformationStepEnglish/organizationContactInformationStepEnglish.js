...
import { OMNIDEF } from './organizationContactInformationStepEnglish_def.js';
import tmpl from './organizationContactInformationStepEnglish.html';
import tmpl_nds from './organizationContactInformationStepEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class organizationContactInformationStepEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
