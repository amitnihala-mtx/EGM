...
export default class GrantsBudgetReviewOS extends OmniscriptBaseMixin(LightningElement) {
    @api recordId;
    @track budgetDetails = [];
    budgetDetailsCpy = [];
    ...
    connectedCallback(){
        console.log(JSON.stringify(this.omniJsonDataS));
    ...
    getBudgetDeatils(){
        ...
        const params = {
            ...
            sClassName: 'grants_BudgetController',
        ...
        this._actionUtil
            ...
            .then(response => {
                ...
                window.console.log(JSON.stringify(this.omniJsonData));
                console.log('resr'+JSON.stringify(response));
                let tempData = JSON.parse(response.result.budgetInfo);
    ...
    upsertBudgetLineItem(event){
        ...
        const lineItemData = {
            'lineitem' : JSON.stringify(lineItemToUpsert)
        }

        const params = {
            input: JSON.stringify(this.omniJsonData),
            sClassName: 'grants_BudgetController',
            sMethodName: 'upsertLineItem',
