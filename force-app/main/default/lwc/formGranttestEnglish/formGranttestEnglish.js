...
import { OMNIDEF } from './formGranttestEnglish_def.js';
import tmpl from './formGranttestEnglish.html';
import tmpl_nds from './formGranttestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class formGranttestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
